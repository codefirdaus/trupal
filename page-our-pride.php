<?php get_header() ?>
    ...
    <div class="ourstorybox" style="background-color: #d7f1f9;  margin: 0; padding: 0; position: relative;">
        ...
        <div class="ourstorybox" style="background-color: #ecf3fb;  margin: 0; padding: 0;">
            <div class="row g-0">
                <div class="col-sm-5">
                    ...
                    <div class="talk-bubble tri-right border round btm-left-in" style="width: 30vw; position: absolute; top: 180px; left: 30px; background-color: white; box-shadow: 10px #666;">
                        <div class="talktext">
                    ...
                    <div class="kamal-img" style="position: absolute; width: 170px; top: 95px; left: 20vw;">
        ...
        <div class="ourstorybox" style="background-color: #f9f6d0;  margin: 0; padding: 0;">
            <div class="row g-0">
                <div class="col-sm-7">
                    <div class="ourstorybox" style="margin: 10px -50px; padding: 5vmax 17vh;">
                ...
                <div class="col-sm-5">
                    <div class="bubble-responsive">
                        ...
                        <div style="position: absolute; width: 170px; bottom: 170px; right: 180px;">
